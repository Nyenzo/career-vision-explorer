          ...
          <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-32">
            <div className="space-y-4">
              ...
              <p className="text-lg text-on-surface-variant leading-relaxed">
                Join an elite network of visionary architects, founders, and
                seekers. Your next great partnership begins with a single step.
              </p>
            </div>
            ...
            <form className="space-y-8" onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <label
                    className={`role-option relative flex items-center p-4 rounded-md cursor-pointer transition-all group border ${selectedRole === "jobseeker" ? "bg-secondary-fixed border-primary shadow-[0_0_0_1px_#004ac6]" : "bg-surface-container-low hover:bg-surface-container-high border-transparent"}`}
                  >
                    <input
                      {...form.register("role")}
                      ...
                      disabled={isLoading}
                    />
                    <span className="ml-4 font-medium text-on-surface">
                      I am Looking for a Job
                    </span>
                    <span className="ml-auto material-symbols-outlined text-outline-variant group-hover:text-primary">
                      person_search
                    </span>
                  </label>
                  <label
                    className={`role-option relative flex items-center p-4 rounded-md cursor-pointer transition-all group border ${selectedRole === "employer" ? "bg-secondary-fixed border-primary shadow-[0_0_0_1px_#004ac6]" : "bg-surface-container-low hover:bg-surface-container-high border-transparent"}`}
                  >
                    <input
                      {...form.register("role")}
                      className="w-4 h-4 text-primary focus:ring-primary/20 border-outline-variant bg-transparent"
