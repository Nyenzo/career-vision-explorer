...
export const JobHeader = ({ job, showMatchScore = true }: JobHeaderProps) => {
  ...
  const score =
    rawScore != null ? Math.round(rawScore * (rawScore <= 1 ? 100 : 1)) : null;
  ...
  return (
    <section className="bg-surface-container-lowest p-10 rounded-lg shadow-sm relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start md:items-center">
        ...
        <div>
          <h1
            className={`text-4xl font-headline font-bold text-on-surface tracking-tight mb-4 ${showMatchScore ? "pr-32" : ""}`}
          >
            {roleTitle}
          </h1>
